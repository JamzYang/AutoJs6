...
import org.ys.game.pio.PFiles.deleteFilesOfDir
import org.ys.game.util.MD5Utils.md5
...
class AndroidClassLoader(private val parent: ClassLoader, private val cacheDir: File) : ClassLoader(), GeneratedClassLoader {
    ...
    fun loadDex(file: File): DexClassLoader {
        ...
        //  ! Writable dex file '/data/user/0/org.ys.gamecat/cache/classes/xxx.jar' is not allowed.
        file.setReadOnly()
