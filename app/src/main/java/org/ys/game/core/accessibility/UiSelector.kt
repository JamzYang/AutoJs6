...
import org.ys.game.annotation.ScriptInterface
import org.ys.game.app.GlobalAppContext
import org.ys.game.concurrent.VolatileBox
import org.ys.game.core.automator.ActionArgument
import org.ys.game.core.automator.UiObject
import org.ys.game.core.automator.UiObject.Companion.COMPASS_PASS_ON
import org.ys.game.core.automator.UiObject.Companion.Detector
import org.ys.game.core.automator.UiObject.Companion.Detector.Result
import org.ys.game.core.automator.UiObject.Companion.RESULT_TYPE_WIDGET
import org.ys.game.core.automator.UiObjectActions
import org.ys.game.core.automator.UiObjectCollection
import org.ys.game.core.automator.UiObjectCollection.Companion.EMPTY
import org.ys.game.core.automator.UiObjectCollection.Companion.of
import org.ys.game.core.automator.filter.ActionFilter
import org.ys.game.core.automator.filter.AppFilter
import org.ys.game.core.automator.filter.BooleanFilter
import org.ys.game.core.automator.filter.BoundsFilter
import org.ys.game.core.automator.filter.ClassNameFilter
import org.ys.game.core.automator.filter.ContentFilter
import org.ys.game.core.automator.filter.DescFilter
import org.ys.game.core.automator.filter.DoubleMinFilter
import org.ys.game.core.automator.filter.Filter
import org.ys.game.core.automator.filter.IdFilter
import org.ys.game.core.automator.filter.IdHexFilter
import org.ys.game.core.automator.filter.IntFilter
import org.ys.game.core.automator.filter.MaxIntFilter
import org.ys.game.core.automator.filter.MetricsFilter
import org.ys.game.core.automator.filter.MetricsMaxFilter
import org.ys.game.core.automator.filter.MetricsMinFilter
import org.ys.game.core.automator.filter.MetricsRangeFilter
import org.ys.game.core.automator.filter.MinIntFilter
import org.ys.game.core.automator.filter.PackageNameFilter
import org.ys.game.core.automator.filter.Selector
import org.ys.game.core.automator.filter.TextFilter
import org.ys.game.core.automator.filter.ToleranceFilter
import org.ys.game.core.automator.search.BFS
import org.ys.game.core.automator.search.DFS
import org.ys.game.core.automator.search.SearchAlgorithm
import org.ys.game.runtime.exception.ScriptInterruptedException
import org.ys.game.util.App
import org.ys.game.util.RhinoUtils
import org.ys.game.util.StringUtils.convertRegex
import org.ys.game.util.StringUtils.str
